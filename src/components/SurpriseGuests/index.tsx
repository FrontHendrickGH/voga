...
import classes from "./SurpriseGuests.module.scss";
import Image from "next/image";
import CTA from "../CTA";

const SurpriseGuests = () => {
	return (
		<section className={classes.surprise}>
			<div className={classes.container}>
				<div className={classes.hero}>
					<div className={classes.containerTitle}>
						<h3>SORPRENDE A TUS INVITADOS CON SABORES INOLVIDABLES.</h3>
						<svg
							width="45"
							height="37"
							viewBox="0 0 45 37"
					...
					<div className={classes.schedule}>
						<Image
							src={"/cocina-polaroid.png"}
							fill
							alt="Sorprende a tus invitados con nuestra alta cocina"
						/>
					</div>
				</div>
				<div className={classes.service}>
					<h3>Servicio de banquetes en nuestros salones incluye:</h3>
					<div className={classes.services}>
						<div>
							<h3>Servicios en salón</h3>
							<ul>
								<li>Uso de el lugar por 6 horas.</li>
								<li>Loza y cristalería.</li>
								<li>Meseros (1 x 25 comensales).</li>
								<li>Capitán y cantinero.</li>
								<li>Servicio de seguridad y valet parking.</li>
								<li>Mobiliario (mesas, sillas, etc.)</li>
								<li>Mantelería ( blanco e ivory) </li>
								<li>En área exterior, sombrillas y calentones.</li>
							</ul>
						</div>
						<div>
							<h3>Música</h3>
							<ul>
								<li>
									Servicio de sonido incluido. (Con un mínimo de 200 platillos
									contratados en VOGA o 120 en Los Jardínes).
								</li>
								<li>Incluye bocinas medias, bajos, mezcladores y DJ.</li>
								<li>
									Otras opciones del sonido tendrán un costo por separado.
								</li>
							</ul>
						</div>
						<div>
							<h3>Licor</h3>
							<ul>
								<li>Servicio de licor incluido.</li>
								<li>
									Incluye: Tequila Tradicional, Vodka Absolut, Ron, Bacardi,
									Brandy Don Pedro, Ginebra, Mezcal, Whiskey, Vino Blanco y
									Tinto de la Casa Cetto, Cerveza Tecate y Tecate Light,
									Refrescos.
								</li>
								<li>No se cobra descorche en licor importado.</li>
							</ul>
						</div>
					</div>
				</div>
				<div className={classes.containerCTA}>
					<CTA
						backgroundColor="#E59939"
						title={{
							title: (
								<span>
									Pregunta por nuestros precios <br /> y paquetes especiales
								</span>
							),
							color: "#EDECEB",
						}}
