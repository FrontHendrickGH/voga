...
import classes from "./PerfectCoordination.module.scss";
import CTA from "../CTA";
import Image from "next/image";

const PerfectCoordination = () => {
	return (
		<div className={classes.perfect}>
			<div className={classes.hero}>
				...
				<div className={classes.schedule}>
					<p>
						Nuestro servicio de coordinación te acompaña desde la planeación
						hasta la ejecución. Nos encargamos de que cada detalle esté en su
						lugar, creando un evento impecable que refleje tu estilo y
						personalidad.
						<br /> <br />
						Nuestro equipo de coordinadores profesionales te ayudarán a
						seleccionar todos los detalles de decoración para ayudarte a lograr
			...
			<figure>
				<Image
					src={"/coordination-image.jpg"}
					alt="Ilustración sobre la coordinación con la que contamos"
					fill
				/>
			</figure>
			<CTA
...
export default PerfectCoordination;
