...
import classes from "./CelebrateMoments.module.scss";
import Link from "next/link";

const CelebrateMoments = () => {
	return (
		<section className={classes.celebrate}>
			<div className={classes.hero}>
				<div className={classes.containerTitle}>
					<h3>Celebra tus momentos más importantes con nosotros.</h3>
					<svg
						width="45"
						height="37"
						viewBox="0 0 45 37"
				...
				<div className={classes.schedule}>
					<p>
						Construimos una experiencia a prueba de errores en donde contarás
						con un equipo de profesionales que te estará guiando en todo
						momento. Desde bodas elegantes y sofisticadas en Tijuana hasta Sweet
						Sixteen y eventos sociales exclusivos, decoración, banquete y
						coordinación.
					</p>
					<Link href={"#"}>Agenda una visita</Link>
				</div>
			</div>
			<div className={classes.cards}>
				<article className={classes.card}>
					...
					<h3>
						Servicio y <br /> atención personalizada.
					</h3>
					<p>
						Nuestro equipo de asesores te atenderá de manera personalizada para
						resolver todas tus dudas y ayudarte con los detalles de tu evento.
					</p>
				</article>
				<article className={classes.card}>
					<svg
					...
					<p>
						Contamos con la experiencia y capacidad para poder ofrecerte todo lo
						que necesitas para ese día tan especial, cuentanos tu idea y haremos
						lo posible por hacerla realidad.
					</p>
				</article>
				<article className={classes.card}>
					<svg
					...
					<p>
						Por nuestra ubicación, la arquitectura de nuestros salones y el
						profesionalismo de nuestros colaboradores, somos el lugar más
						exclusivo de Tijuana.
					</p>
				</article>
			</div>
		</section>
